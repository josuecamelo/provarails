class CarrosController < ApplicationController
  before_action :set_carro, only: [:show, :edit, :update, :destroy, :importar]
  ...
  def update
    respond_to do |format|
      if (!carro_params[:disponivel].present?)
        carro_params[:disponivel] = false
      end
  ...
  private
    ...
    def carro_params
      params.fetch(:carro, {}).permit(:marca,:disponivel, :modelo)
    end
end
